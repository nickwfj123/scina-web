<div class="wrapper row4">
    <footer id="footer" class="hoc clear">
        ...
        <div class="one_third first">
            <h6 class="title">Citation</h6>
            <p>Please cite this reference:</p>
        ...
        <div class="one_third">
            ...
            <ul class="nospace linklist contact">
                ...
                <li><i class="fa fa-envelope-o"></i> <a href="mailto:Tao.Wang@utsouthwestern.edu">Tao.Wang@utsouthwestern.edu</a>
                </li>
                <li><i class="fa fa-home"></i> <a href="https://www.utsouthwestern.edu/labs/wang-tao/" target="_blank">Wang
                        Lab Website</a></li>
            </ul>
        </div>
        <!-- ################################################################################################ -->
